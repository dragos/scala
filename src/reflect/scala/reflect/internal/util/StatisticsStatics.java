...
public final class StatisticsStatics {
  ...
  private static final AlmostFinalValue COMPILATION_UNIT_STATS = new AlmostFinalValue();
  ...
  public static final MethodHandle COMPILATION_UNIT_STATS_GETTER = COMPILATION_UNIT_STATS.invoker;
  ...
  public static void enableCompilationUnitStatsAndDeoptimize() { COMPILATION_UNIT_STATS.toggleOnAndDeoptimize(); }
}
